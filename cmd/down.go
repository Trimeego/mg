...
var downCmd = &cobra.Command{
	Use:   "down",
	Short: "Migrate down a specific number of versions",
	Long:  `Migrate down a specific number of versions.  Number of versions is required for your protection.  If you would like to migrate to a specific version, use 'goto'`,
